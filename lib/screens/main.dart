...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<DarkThemeProvider>(
      builder: (BuildContext context, darkThemeProvider, Widget child) {
        darkThemeProvider.darkThemePreferences
            .getTheme()
            .then((isDark) => darkThemeProvider.isDark = isDark);
        return MaterialApp(
          title: 'RunLah',
          home: InitialScreen(),
          theme: Styles.themeData(darkThemeProvider.isDark, context),
